...
function paginatorHelper(options) {
    ...
    if (prevNext) {
        ...
        else  result += '<span class="extend disable prev" rel="prev">' + prevText + '</span>'
    ...
    if (prevNext) {
        ...
        else  result += '<span class="extend disable next" rel="next">' + nextText + '</span>'
    }

    return result;
}

hexo.extend.helper.register('my_paginator', paginatorHelper);